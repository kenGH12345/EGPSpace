...
- **Score**: 20/100
- **Warnings**:
  - ⚠️ Content length (14 lines) outside expected range (25-600)
  - ⚠️ Too few sections (2, expected >= 3)
  - ⚠️ Missing required sections: phases, dependencies
  - ⚠️ JSON metadata missing or malformed
- **Checks**:
...
- **Score**: 45/100
- **Warnings**:
  - ⚠️ Content length (8426 lines) outside expected range (10-5000)
...
### 🟢 [LOW] missing_sections
- **Message**: Stage PLAN missing sections: phases, dependencies
- **Action**: Add required sections to output templates
- **Stage**: PLAN
