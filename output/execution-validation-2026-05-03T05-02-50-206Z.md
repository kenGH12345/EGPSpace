...
- **Score**: 35/100
- **Warnings**:
  - ⚠️ Content length (29 lines) outside expected range (30-800)
...
- **Score**: 35/100
- **Warnings**:
  - ⚠️ Content length (20 lines) outside expected range (25-600)
  - ⚠️ Missing required sections: tasks, dependencies
  - ⚠️ JSON metadata missing or malformed
- **Checks**:
...
- **Score**: 50/100
- **Warnings**:
  - ⚠️ Missing required sections: summary
  - ⚠️ JSON metadata missing or malformed
- **Checks**:
...
### 🟢 [LOW] missing_sections
- **Message**: Stage PLAN missing sections: tasks, dependencies
- **Action**: Add required sections to output templates
- **Stage**: PLAN

### 🟢 [LOW] missing_sections
- **Message**: Stage TEST missing sections: summary
- **Action**: Add required sections to output templates
- **Stage**: TEST
