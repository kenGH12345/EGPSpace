...
- **Score**: 50/100
- **Warnings**:
  - ⚠️ Missing required sections: tech-stack, data-flow
  - ⚠️ JSON metadata missing or malformed
- **Checks**:
...
- **Score**: 45/100
- **Warnings**:
  - ⚠️ Content length (6 lines) outside expected range (10-5000)
...
### 🟢 [LOW] missing_sections
- **Message**: Stage ARCHITECT missing sections: tech-stack, data-flow
- **Action**: Add required sections to output templates
- **Stage**: ARCHITECT
